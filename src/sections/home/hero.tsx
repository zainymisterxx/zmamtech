...
export default async function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <Container className="relative z-10 pt-16 pb-20 sm:pt-20 sm:pb-24 lg:pt-24 lg:pb-28">
          ...
          <div className="animate-fade-in-up stagger-3 mt-10 flex flex-wrap items-center gap-4">
            ...
            {whatsapp ? (
              ...
              >
                <button
                  type="button"
                  className="inline-flex items-center gap-2 px-7 py-3.5 rounded-xl bg-[#25D366] text-white text-sm font-semibold transition-all duration-300 hover:bg-[#1ebe57] hover:shadow-hover active:scale-[0.97]"
                >
