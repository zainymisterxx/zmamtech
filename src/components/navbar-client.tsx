...
export default function NavbarClient({ brandName, logoUrl, whatsapp }: NavbarClientProps) {
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          {whatsappUrl ? (
            <a
              ...
              id="nav-cta"
              className="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl bg-[#25D366] text-white text-sm font-semibold transition-all duration-300 hover:bg-[#1ebe57] hover:shadow-hover active:scale-[0.97]"
            >
